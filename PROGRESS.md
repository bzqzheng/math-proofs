...
|---|---|---|---|---|
| `bash-53si6yjm` | Erdős #699 binomial gcd | `attempts/scan_699.py` to `10^9` | `n ≈ 576M`, `5.7B` cases checked, **0 counterexamples** | 6 h (~45 min left) |
| `bash-51p87u8h` | Erdős #470 odd weird | `attempts/search_odd_weird` SPF=3 shard to `10^24` | `141B` nodes, `262,801` candidates, **0 weird** | 7 h (~2.8 h left) |
