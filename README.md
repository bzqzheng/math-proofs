...
- **Compounding insights.** Twelve problem-generic lessons so far about oracle design, search structure, and when *not* to compute. Shortest valuable read in the repo. → `docs/insights.md`
