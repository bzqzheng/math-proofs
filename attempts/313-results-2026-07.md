...
| $k$ | 3 | 4 | 5 | 6 | 7 | 8 |
|---|---|---|---|---|---|---|
| $\Sigma_k$ | 0.716 | 0.874 | 0.855 | 0.779 | 0.781 | 0.689 |
| $S_k$ (exhaustive) | 1 | 1 | 1 | 1 | 1 | 1 |
...
**Reading.** $\Sigma_k$ is flat and of order 1 — it does *not* decay. If this persists,
$\sum_k S_k=\infty$: **the heuristic says the answer to Erdős #313 is YES**, with the number of PPNs
having exactly $k$ prime factors staying $O(1)$ on average, i.e. the counting function of PPNs
grows like $c\cdot k$ in the number of prime factors, i.e. roughly like
$\log\log\log n$ in $n$ (PPNs with $k$ factors have size doubly-exponential in $k$).
...
$r=8$ PPN. The model was not tuned in any way; this is an out-of-sample hit and it says the
$\Sigma$-ranking is a usable search prior for the next layer.
