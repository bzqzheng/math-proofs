...
Source material: `source-report-2026-07.md` (Perplexity report, July 2026)
...
- **Jacobian conjecture falsified in dimension 3** by Levent Alpöge with
  ...
  `../problems/jacobian-dim3/verify_jacobian_counterexample.py`):
...
1. **Oracle first.** No candidate counts unless a deterministic checker
   ...
   Jacobian verification script in `../problems/jacobian-dim3/` is the template.
...
- 2026-07-24: Full offline verification pass (see verification-report.md).
