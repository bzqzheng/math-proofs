...
| `erdos-375/` | Grimm's conjecture: distinct prime divisors for consecutive composites | **BOUND-EXTENDED** | **0 counterexamples for all n ≤ 10¹²** (37.6B blocks, 8 shards, 12.6 core-hours) — **52× the published frontier** (1.9×10¹⁰, Laishram–Shorey 2006); exact engine (k-smooth reduction + Hopcroft–Karp) gated against sympy oracle + A005250; logs in dir |
...
| `erdos-287/` | Egyptian fractions, gaps ≤ 2 | **BOUND-EXTENDED** | No counterexample for k ≤ 54 (C MITM `mitm_287.c`, exact-equivalence gates vs Python; k=54: 860M+1.33B halves, 189 s, 32 GB); k ≥ 55 needs ~137 GB or a streaming-table redesign |
