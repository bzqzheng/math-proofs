...
- **No counterexample for k ≤ 35 (exhaustive MITM, ~20 s total, 2026-07-30).**
- k = 36..39 exhaustive: running. k ≥ 40 needs a memory-optimized (C) port —
  the Python hash table grows ~2× per k.
